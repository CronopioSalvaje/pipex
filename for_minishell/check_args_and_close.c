...
/*   Updated: 2024/04/23 14:01:25 by dagudelo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "pipex.h"

static void	check_cmd1_arg(char *cmd1, char **cmd_args, t_data *data)
{
	if (cmd1 && *cmd1)
	{
...
static void	check_cmd2_arg(char *cmd2, char **cmd_args, t_data *data)
{
	if (cmd2 && *cmd2)
	{
